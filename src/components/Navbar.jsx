...
const Navbar = () => {
  // 优先从 localStorage 读取用户之前选的主题，默认 system
  ...
  useEffect(() => {
    ...
    const applyTheme = () => {
      if (theme === 'dark') {
        ...
        removeDark(); // 🚨 只有配合 index.css 和 App.jsx 的修改，这行才会肉眼可见地生效
    ...
    <nav className="fixed w-full z-20 top-0 start-0 border-b border-zinc-200 dark:border-zinc-700 bg-white/90 dark:bg-slate-900/90 backdrop-blur-sm transition-colors duration-300">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="#" className="flex items-center space-x-3 rtl:space-x-reverse">
          <span className="self-center text-2xl font-semibold whitespace-nowrap text-zinc-800 dark:text-indigo-400">YourName</span>
        </a>
